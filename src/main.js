...
// アンケート・車いす・会議室予約・美容液アンケート、すべて同じApps Script
...
const katsuoFacts = [
  {
    ...
    body: '江戸時代から続くとされる久礼の一本釣り漁（土佐藩のカツオ節奨励が背景にあります）。竿一本で魚を引き上げるこの漁法は魚体を傷つけにくく、鮮度抜群の刺身が楽しめます。藁焼きたたきは家庭料理とも言えるほど高知の食卓に根付いており、高知の人々は楽しみながらたたきを振る舞います。今も現役の漁師たちが受け継ぐ、久礼の誇りです。',
  },
  {
    badge: '文化',
  ...
  {
    badge: '文化',
    title: 'ふるさと海岸の青柳裕介 石像',
    lead: '久礼のふるさと海岸（久礼八幡宮前）には、青柳裕介さんの石像が建っています。',
    body: '「土佐の一本釣り」で久礼の漁師の暮らしとカツオ一本釣りの魂を全国に伝えた漫画家・青柳裕介さん。その功績をたたえ、海を見渡すふるさと海岸に石像（記念碑）が建てられました。久礼を訪れたらぜひ立ち寄ってみてください。',
  },
  {
    badge: '伝説',
    title: '双名島（土佐十景）',
  ...
  },
  {
    badge: '栄養',
    title: 'カツオは栄養が豊富な赤身魚',
    lead: '高タンパクで、鉄分やビタミンB群などの栄養素を含みます。',
    body: 'カツオは良質なタンパク質を多く含み、鉄分やビタミンB群などの栄養素も含む赤身魚です。季節によって脂ののりや味わいが変わり、たたきや刺身など、いろいろな食べ方で楽しめます。',
  },
  {
    badge: '部位',
    title: 'ハランボは脂のりが自慢の部位',
    lead: 'ハランボはカツオのお腹側、脂のりが豊かな部位です。',
    body: 'カツオの腹身「ハランボ」は、程よく脂がのった濃厚な旨味が特徴。市場で焼いた串を片手に歩ける久礼スタイルは、気軽に楽しめる名物です。串の大きさや量はお店によって異なります。',
  },
  {
    badge: '季節',
    title: 'メジカのシンコとは？',
    lead: 'メジカのシンコは、ソウダガツオ（主にマルソウダ）の生後1年未満の幼魚。久礼など水揚げ地でしか刺身で味わえない“幻の味”です。',
    body: '高知ではソウダガツオを、目と口が近いことから「メジカ（目近）」と呼び、その幼魚を「シンコ（新子）」と呼びます。旬は8月中旬〜9月下旬ごろのわずか1か月前後（漁や天候で前後します）。とても鮮度が落ちやすく「朝釣れたシンコは昼までに食え」と言われるほどで、産地以外ではほぼ刺身で流通しません。久礼では、皮を引いた刺身にブシュカン（仏手柑）を皮ごとすりおろして果汁を搾り、醤油でいただくのが定番。モチモチした弾力と濃厚な旨み、ブシュカンの爽やかな香りが絶品です。',
  },
];
...
const towerGuides = [
  {
    ...
    body: '「八千代タワー」と「純平タワー」は、久礼を舞台にした漫画「土佐の一本釣り」の登場人物に由来しています。この漫画を描いたのは漫画家・青柳裕介さん。主人公の小松純平とヒロインの八千代の名前が、地域の大切な防災施設に刻まれています。',
  },
  {
    badge: '観光客向け',
    title: '到着したら避難方向を確認',
  ...
  if (route === 'tower') {
    const evacuationCard = `
      <section class="evacuation-card">
        <h3>🚨 久礼の避難場所（一例）</h3>
        <p class="evacuation-card__note">地震を感じたらすぐ高台へ。下記はあくまで一例です。正確・最新の避難場所は、町の公式案内や現地表示で必ずご確認ください。</p>
