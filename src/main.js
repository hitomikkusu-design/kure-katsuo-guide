...
const katsuoFacts = [
  ...
  },
  {
    ...
    body: '大正か明治の時代、この町一帯を焼き尽くす大火事が起きました。電話も電報もない時代にもかかわらず、遠く離れた大正天皇がその惨状を知り、復興費として御下賜金350円を賜りました。町の人々はその深い御恩に感謝し、「大正天皇への感謝を永く伝えたい」という思いからこの商店街を「大正町市場」と名付けました。その名は今も受け継がれています。',
  },
  {
    badge: '栄養',
    title: 'カツオは栄養の宝庫',
